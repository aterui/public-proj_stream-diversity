...
\end{equation}
```
where $\Omega_v^{-1}$ is the inverse of the variance-covariance matrix of $v$.
...
\end{equation}
```
We exponentiated $u_i$ and $u_j$ because we log-transformed watershed area and branching probability in the statistical model. Then
