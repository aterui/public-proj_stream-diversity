...
```{r, fig.height=7, fig.width=8, fig.cap="Influences of ecosystem size (A, watershed area) and complexity (B, branching probability) on $\\alpha$ (red), $\\beta$ (green), and $\\gamma$ diversity (blue) in Hokkaido and Midwest regions. Dots represent watershed replicates (i.e., metacommunities), and lines are predicted values from the robust regression models."}
